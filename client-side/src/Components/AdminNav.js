                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mb-lg-0">
                            <li><Link to="/admin/admission-update" className="nav-link text-light me-4" >Admission</Link></li>
                            <li className="nav-item">
                                <Link to="/admin/award" className="nav-link active text-light me-4" aria-current="page" >Awards & Distiction</Link>
                            </li>
                        </ul>
                    </div>
                </div>
